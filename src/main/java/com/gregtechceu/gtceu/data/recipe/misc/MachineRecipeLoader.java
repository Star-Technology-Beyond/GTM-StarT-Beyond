...
public class MachineRecipeLoader {
    ...
    private static void registerAssemblerRecipes(Consumer<FinishedRecipe> provider) {
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_bronze_pipe")
                ...
                .outputItems(CASING_BRONZE_PIPE, ConfigHolder.INSTANCE.recipes.casingsPerCraft)
                .circuitMeta(9)
                .duration(50)
                .EUt(16)
                .save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_steel_pipe")
                ...
                .outputItems(CASING_STEEL_PIPE, ConfigHolder.INSTANCE.recipes.casingsPerCraft)
                .circuitMeta(9)
                .duration(50)
                .EUt(16)
                .save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_titanium_pipe")
                ...
                .outputItems(CASING_TITANIUM_PIPE, ConfigHolder.INSTANCE.recipes.casingsPerCraft)
                .circuitMeta(9)
                .duration(50)
                .EUt(16)
                .save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("casing_ptfe_pipe")
                ...
                .outputItems(CASING_POLYTETRAFLUOROETHYLENE_PIPE, ConfigHolder.INSTANCE.recipes.casingsPerCraft)
                .circuitMeta(9)
                .duration(50)
                .EUt(16)
                .save(provider);
    ...
    private static void registerBlastFurnaceMetallurgyRecipes(Consumer<FinishedRecipe> provider) {
        ...
        BLAST_RECIPES.recipeBuilder("tetrahedrite_metallurgy").duration(120).EUt(VA[MV]).blastFurnaceTemp(1200)
                ...
                .outputItems(dust, CopperIIOxide)
        ...
        BLAST_RECIPES.recipeBuilder("cobaltite_metallurgy").duration(120).EUt(VA[MV]).blastFurnaceTemp(1200)
                ...
                .inputFluids(Oxygen.getFluid(3000))
                .outputItems(dust, CobaltIIOxide)
